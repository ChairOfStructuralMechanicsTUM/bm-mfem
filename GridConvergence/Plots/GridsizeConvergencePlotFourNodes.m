...
hold on
plot([1:1:20],real(DisplacementPorousNode1(:,1)),'*k')
...
hold on
plot([1:1:20],real(DisplacementPorousNode2(:,1)),'*k')
...
hold on
plot([1:1:20],real(DisplacementPorousNode3(:,1)),'*k')
...
hold on
plot([1:1:20],real(DisplacementPorousNode4(:,1)),'*k')
...
figure4 = figure("Name","Solid y-Displacements");
hold on
plot([1:1:20],real(DisplacementPorousTime(:,1)),'*k')

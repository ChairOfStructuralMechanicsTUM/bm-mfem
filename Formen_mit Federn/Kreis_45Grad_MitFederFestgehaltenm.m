...
clear
%%%%%%%%%%%%%% Federtests_Kreis_withInner_0Grad für Halterung in y!
%%%%%%%%%%%%%% Federtests_Kreis_withInner_45Grad für senkrechte Halterung

io=MdpaInput('Federtests_Kreis_withInner_45Grad.mdpa'); %specify input file   
...
figure(2)
title('DC, Kreis 45Grad - mit Feder fixiert')
xlabel('Phase k')
ylabel('frequenzy f')
xlim([0 pi])

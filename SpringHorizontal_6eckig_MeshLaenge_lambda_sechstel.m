...
io=MdpaInput('SpringHorizontal_6eckig_MeshLaenge_lambda_sechstel.mdpa'); %specify input file
...
%%% 2 springs, 1 mass
model.addNewNode(174,0.1,0.075,0);
model.addNewElement('SpringDamperElement3d2n',153,[45 174]);
model.addNewElement('SpringDamperElement3d2n',154,[174 88]);
model.addNewElement('ConcentratedMassElement3d1n',155, 174);

model.getNode(45).addDof("DISPLACEMENT_Z");
model.getNode(88).addDof("DISPLACEMENT_Z");
model.getNode(174).addDof(["DISPLACEMENT_X","DISPLACEMENT_Y","DISPLACEMENT_Z"]);


model.getNode(45).fixDof('DISPLACEMENT_Z');
model.getNode(88).fixDof('DISPLACEMENT_Z');
model.getNode(174).fixDof('DISPLACEMENT_Y');
model.getNode(174).fixDof('DISPLACEMENT_Z');


model.getElement(153).setPropertyValue('ELEMENTAL_STIFFNESS',8.6359e+8);
model.getElement(153).setPropertyValue('ELEMENTAL_DAMPING',0);
model.getElement(154).setPropertyValue('ELEMENTAL_STIFFNESS',8.6359e+8);
model.getElement(154).setPropertyValue('ELEMENTAL_DAMPING',0);

model.getElement(155).setPropertyValue('ELEMENTAL_MASS',7e0);
model.getElement(155).setPropertyValue('VOLUME_ACCELERATION',10);

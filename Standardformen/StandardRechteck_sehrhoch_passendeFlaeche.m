%%%% A = 15 cm^2 h=14.5 h=15/14,5cm = 1.03448cm
%%%% FLÄCHE KLEINER
    
clear

io=MdpaInput('SpringHorizontal_rechteckig_sehrhoch2.mdpa'); %specify input file
...
for j = 1:nob
    ...
    figure(2)
    plot(kx,f(j,:),'r')
    title('Dispersion curves - SRechteck,sehrhoch A=20cm^2')
    xlabel('Phase k')
    ylabel('frequenzy f')
    xlim([0 pi])

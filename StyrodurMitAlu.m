...
%     clc
    ...
    io=MdpaInput('Materials2_3.mdpa'); %specify input file
    ...
    %aluminum
    model.getAllElements.setPropertyValue('YOUNGS_MODULUS',21e10); %7e10
    model.getAllElements.setPropertyValue('POISSON_RATIO',0.34);
    model.getAllElements.setPropertyValue('NUMBER_GAUSS_POINT',2);
    model.getAllElements.setPropertyValue('DENSITY',7868); %2699

classdef SparseTest <  matlab.unittest.TestCase
    ...
    methods (Test)
        function testSparseAssembler(testCase)
            node01 = Node(1,-4,3);
            node02 = Node(2,0,3);
            node03 = Node(3,4,3);
            node04 = Node(4,0,0);
            ...
            actualSolution = SimpleSparseAssembler.assembleGlobalStiffnessMatrix(model);

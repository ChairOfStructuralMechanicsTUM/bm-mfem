classdef MixedPorousElement3d8n < Element
    ...
    methods
        % constructor
        function porous3d8n = MixedPorousElement3d8n(id, nodeArray)
            ...
            porous3d8n.dofNames = cellstr(['DISPLACEMENT_SOLID_X'; 'DISPLACEMENT_SOLID_Y'; 'DISPLACEMENT_SOLID_Z'; 'PRESSURE']);
        ...
        % member functions
        function [N, Nf, Be, B, Jdet] = computeShapeFunction(porous3d8n, zeta, eta, mue)
        ...
        function stiffnessMatrix = computeLocalStiffnessMatrix(porous3d8n)
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % DETERMINES DYNAMIC STIFFNESS MATRIX %
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            for i=1:p
                ...
                for j=1:p
                    ...
                    for k=1:p
                        mue=g(k);
                        [N, Nf, Be, B, Jdet] = computeShapeFunction(porous3d8n, zeta, eta, mue);
            ...
            stiffnessMatrix = [K_Matrix - omega^2 * M_Matrix, - C_Matrix; - omega^2 * transpose(C_Matrix); H_Matrix - omega^2 * Q_Matrix];
        end
        
        function massMatrix = computeLocalMassMatrix(porous3d8n)
            
            massMatrix = zeros(32,32);
        ...
        function dofs = getDofList(element)
            ...
            dofs([25 26 27 28 29 30 31 32]) = element.nodeArray.getDof('PRESSURE');
        end
        ...
        function vals = getValuesVector(element, step)
            ...
            vals([25 26 27 28 29 30 31 32]) = element.nodeArray.getDofValue('PRESSURE',step);
        end
        ...
        function vals = getFirstDerivativesVector(element, step)
            ...
            [~, vals([25 26 27 28 29 30 31 32]), ~] = element.nodeArray.getDof('PRESSURE').getAllValues(step);
        end

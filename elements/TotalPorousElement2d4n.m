classdef TotalPorousElement2d4n < PorousElement2d4n
    %   TotalPorousElement2d4n Summary of this class goes here
    ...
    methods
        ...
        % constructor
        function totalporousElement2d4n = TotalPorousElement2d4n(id,nodeArray)
        ...
        function stiffnessMatrix = computeLocalStiffnessMatrix(totalporousElement2d4n)
            ...
            LAMBDA_SOLID = totalporousElement2d4n.getPropertyValue('LAMBDA_SOLID');
            MUE_SOLID = totalporousElement2d4n.getPropertyValue('MUE_SOLID');
            DAMPING_SOLID = totalporousElement2d4n.getPropertyValue('DAMPING_SOLID');
            
            DENSITY_FLUID = totalporousElement2d4n.getPropertyValue('DENSITY_FLUID');
            VISCOSITY_FLUID = totalporousElement2d4n.getPropertyValue('VISCOSITY_FLUID');
            STANDARD_PRESSURE_FLUID = totalporousElement2d4n.getPropertyValue('STANDARD_PRESSURE_FLUID');
            HEAT_CAPACITY_FLUID = totalporousElement2d4n.getPropertyValue('HEAT_CAPACITY_FLUID');
            PRANDTL_NUMBER_FLUID = totalporousElement2d4n.getPropertyValue('PRANDTL_NUMBER_FLUID');
            
            THERMAL_LENGTH = totalporousElement2d4n.getPropertyValue('THERMAL_LENGTH');
            
            omega = totalporousElement2d4n.getPropertyValue('FREQUENCY');
        ...
        function massMatrix = computeLocalMassMatrix(totalporousElement2d4n)
            % Read Material Properties
            DENSITY_SOLID = totalporousElement2d4n.getPropertyValue('DENSITY_SOLID');
            ...
            FLOW_RESISTIVITY = totalporousElement2d4n.getPropertyValue('FLOW_RESISTIVITY');
            VISCOUS_LENGHT = totalporousElement2d4n.getPropertyValue('VISCOUS_LENGHT');

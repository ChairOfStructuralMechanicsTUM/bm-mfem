classdef QuadrilateralElement2d4nPlaneStrain < QuadrilateralElement
    ...
    methods
        % Constructor
        function quadrilateralElement2d4n = QuadrilateralElement2d4nPlaneStrain(id,nodeArray)
        ...
        function stiffnessMatrix = computeLocalStiffnessMatrix(obj)
            ...
            Emat = EModul/((1+PoissonRatio)*(1-2*PoissonRatio))*[1-PoissonRatio PoissonRatio 0; PoissonRatio 1-PoissonRatio 0; 0 0 (1 - 2*PoissonRatio)/2];

...
% node07 = Node(7,30,0,0);
% 
% nodeArray = [node01 node02 node03 node04 node05 node06 node07];
 
%%%SUBSTRUCTURE02
% node06 = Node(1,30,9,0);
% node07 = Node(2,30,0,0);
% node08 = Node(3,40,8,0);
% node09 = Node(4,40,0,0);
% node10 = Node(5,50,5,0);
% node11 = Node(6,50,0,0);
% node12 = Node(7,60,0,0);
% 
% nodeArray = [node06 node07 node08 node09 ...
...
% ele02 = BarElement3d2n(2,[node03 node05], mat, 2);
% ele03 = BarElement3d2n(3,[node05 node07], mat, 2);
% ele07 = BarElement3d2n(4,[node01 node02], mat, 10);
% ele08 = BarElement3d2n(5,[node02 node04], mat, 10);
% ele09 = BarElement3d2n(6,[node04 node06], mat, 10);
% ele13 = BarElement3d2n(7,[node02 node03], mat, 3);
% ele14 = BarElement3d2n(8,[node04 node05], mat, 3);
% ele15 = BarElement3d2n(9,[node06 node07], mat, 3);
% ele18 = BarElement3d2n(10,[node02 node05], mat, 1);
% ele19 = BarElement3d2n(11,[node04 node07], mat, 1);
% 
% 
% elementArray = [ele01 ele02 ele03 ele07 ele08 ele09 ...
%      ele13 ele14 ele15  ele18 ele19];


%%%SUBSTRUCTURE02
% ele04 = BarElement3d2n(1,[node07 node09], mat, 2);
% ele05 = BarElement3d2n(2,[node09 node11], mat, 2);
% ele06 = BarElement3d2n(3,[node11 node12], mat, 2);
% ele10 = BarElement3d2n(4,[node06 node08], mat, 10);
% ele11 = BarElement3d2n(5,[node08 node10], mat, 10);
% ele12 = BarElement3d2n(6,[node10 node12], mat, 10);
% ele15 = BarElement3d2n(7,[node06 node07], mat, 3);
% ele16 = BarElement3d2n(8,[node08 node09], mat, 3);
% ele17 = BarElement3d2n(9,[node10 node11], mat, 3);
% ele20 = BarElement3d2n(10,[node07 node08], mat, 1);
% ele21 = BarElement3d2n(11,[node09 node10], mat, 1);
% 
% elementArray = [ele04 ele05 ele06  ...
%     ele10 ele11 ele12 ele15 ele16 ele17  ...
%     ele20 ele21];
...
addPointLoad([node03 node05 node02],10,[1 -1 0]);

...
io=MdpaInput('lambda_zehntel_structured.mdpa'); %specify input file
...
% %% 2 springs, 1 mass
model.addNewNode(128,0.1,0.075,0);
model.addNewElement('SpringDamperElement3d2n',106,[68 128]);
model.addNewElement('SpringDamperElement3d2n',107,[128 34]);
model.addNewElement('ConcentratedMassElement3d1n',108, 128);

model.getNode(68).addDof("DISPLACEMENT_Z");
model.getNode(34).addDof("DISPLACEMENT_Z");
model.getNode(128).addDof(["DISPLACEMENT_X","DISPLACEMENT_Y","DISPLACEMENT_Z"]);


model.getNode(68).fixDof('DISPLACEMENT_Z');
model.getNode(34).fixDof('DISPLACEMENT_Z');
model.getNode(128).fixDof('DISPLACEMENT_Y');
model.getNode(128).fixDof('DISPLACEMENT_Z');


model.getElement(106).setPropertyValue('ELEMENTAL_STIFFNESS',8.6359e+8);
model.getElement(106).setPropertyValue('ELEMENTAL_DAMPING',0);
model.getElement(107).setPropertyValue('ELEMENTAL_STIFFNESS',8.6359e+8);
model.getElement(107).setPropertyValue('ELEMENTAL_DAMPING',0);

model.getElement(108).setPropertyValue('ELEMENTAL_MASS',7e0);
model.getElement(108).setPropertyValue('VOLUME_ACCELERATION',10);
...
m = model.getElement(108).getPropertyValue('ELEMENTAL_MASS');
k1 = model.getElement(106).getPropertyValue('ELEMENTAL_STIFFNESS');
k2 = model.getElement(107).getPropertyValue('ELEMENTAL_STIFFNESS');

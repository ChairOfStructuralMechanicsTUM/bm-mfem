...
elementArray(3:9).setPropertyValue('YOUNGS_MODULUS',1000);
elementArray(1).setPropertyValue('YOUNGS_MODULUS',500);
elementArray(2).setPropertyValue('YOUNGS_MODULUS',500);

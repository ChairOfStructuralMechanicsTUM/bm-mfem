...
function [DisplacementPorousNode1, DisplacementPorousNode2, DisplacementPorousNode3, DisplacementPorousNode4] = ModelTestForPorousConvergence(Porosity)
clc
...
DisplacementPorousNode4(1,4)=DisplacementHomogenousSolid(nx+1,4);
...
DisplacementPorousNode3(1,4)=DisplacementHomogenousSolid(round((nx+1)*3/4),4);
...
DisplacementPorousNode2(1,4)=DisplacementHomogenousSolid(round((nx+1)*2/4),4);
...
DisplacementPorousNode1(1,4)=DisplacementHomogenousSolid(round((nx+1)*1/4),4);

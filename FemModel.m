classdef FemModel < handle
    ...
    methods
        ...
        %(4) sets the step to 1
            ...
            femModel.dofArray = arrayfun(@(node) node.getDofArray, femModel.nodeArray, 'UniformOutput', false)';  %dof Array=[2x1;2x1;2x1...] 2=x und y FG
            femModel.dofArray = [femModel.dofArray{:}];   %dofArray=[1x1 1x1 1x1] (mit doppelter Länge, da x und y jew eigene Einträge haben)

...
io=MdpaInput('SpringHorizontal_6eckig.mdpa'); %specify input file
...
%%% 2 springs, 1 mass
model.addNewNode(380,0.1,0.075,0);
model.addNewElement('SpringDamperElement3d2n',332,[113 380]);
model.addNewElement('SpringDamperElement3d2n',333,[380 180]);
model.addNewElement('ConcentratedMassElement3d1n',334, 380);

model.getNode(113).addDof("DISPLACEMENT_Z");
model.getNode(180).addDof("DISPLACEMENT_Z");
model.getNode(380).addDof(["DISPLACEMENT_X","DISPLACEMENT_Y","DISPLACEMENT_Z"]);


model.getNode(113).fixDof('DISPLACEMENT_Z');
model.getNode(180).fixDof('DISPLACEMENT_Z');
model.getNode(380).fixDof('DISPLACEMENT_Y');
model.getNode(380).fixDof('DISPLACEMENT_Z');


model.getElement(332).setPropertyValue('ELEMENTAL_STIFFNESS',8.6359e+8);
model.getElement(332).setPropertyValue('ELEMENTAL_DAMPING',0);
model.getElement(333).setPropertyValue('ELEMENTAL_STIFFNESS',8.6359e+8);
model.getElement(333).setPropertyValue('ELEMENTAL_DAMPING',0);

model.getElement(334).setPropertyValue('ELEMENTAL_MASS',7e0);
model.getElement(334).setPropertyValue('VOLUME_ACCELERATION',10);
...
m = model.getElement(334).getPropertyValue('ELEMENTAL_MASS');
k1 = model.getElement(332).getPropertyValue('ELEMENTAL_STIFFNESS');
k2 = model.getElement(333).getPropertyValue('ELEMENTAL_STIFFNESS');

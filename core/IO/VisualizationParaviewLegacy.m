classdef VisualizationParaviewLegacy < handle
    ...
    methods
        ...
        % constructor
        function obj = VisualizationParaviewLegacy(femModel, filename, varargin)
            obj.model = femModel;
        ...
        function vtkWrite(obj)
            ...
            fid = fopen([obj.filename, num2str(tstep), '.vtk'], 'w');

   ...
   methods (Static)
       ...
       function [K,bc,br,in,gbc,gbr,gin]= substructureNodeMatrix(nodematrix,Ns,v,hz,dim)
           ...
           elseif Ns==1
            ...
            %entstehen durch die Abrundung (floor) an den Rändern Substrukturen mit sehr vielen Knoten
...
%                     end
           ...
           for i=1:hz
                     ...
                     for e=1:length(srdofid)
                         ...
                         sbrDofId(t)=srdofid(e);  %nicht vorbelegen, für jede substruktur andere Länge
                         t=t+1;
                         end
                     end
            ...
            ubrin=[];
               ...
               for j=1:v
                 ...
                 %sbrDof Id bestimmen:
                 sbrdofid=sgbrDofId{j,i};  %globale Freiheitsgradnummern müssen in Reihenfolge von ur2 umgeändert werden
%                  %Bsp; ur2=[15 16 23 24] in globalen nummern, dann
%                  %enstrpicht 15 der 1 und  24 der 4 usw.
%                  sbrDofId=[];
% 
